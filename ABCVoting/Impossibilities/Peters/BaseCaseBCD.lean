...
lemma stepI
  ...
  have hW_ne_bad : W f hres P_party h_party ≠ W_bad := by
    ...
    have h_viol :
      ...
      -- rewrite `W_bad` to the actual outcome at `P_party` and `W_true` to the actual outcome at `P_true`
      have h_gain :
...
-- ============================================================================
-- HELPER: PROPORTIONALITY MEMBERSHIP ON PARTY-LIST PROFILES
-- ============================================================================
...
-- ============================================================================
-- HELPER: EXCLUSIVE SINGLETON FOR SINGLETON-APPROVERS LEMMA
-- ============================================================================
