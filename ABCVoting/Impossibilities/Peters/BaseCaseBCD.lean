...
def ballot_bc : Finset C := {1, 2}
def ballot_bd : Finset C := {1, 3}
...
@[simp] lemma insert_d_ballot_ac : insert (3 : C) ballot_bc = comm_bcd := by decide
@[simp] lemma insert_b_ballot_cd : insert (0 : C) ballot_cd = comm_acd := by decide
@[simp] lemma insert_b_ballot_ad : insert (0 : C) ballot_bd = comm_abd := by decide
@[simp] lemma insert_c_ballot_ab : insert (2 : C) ballot_ab = comm_abc := by decide
@[simp] lemma insert_b_ballot_ac : insert (0 : C) ballot_bc = comm_abc := by decide

def P₁ : Profile := ![ballot_ab, ballot_c, ballot_d]
def P₁_₅ : Profile := ![ballot_ab, ballot_bc, ballot_d]
def P₂ : Profile := ![ballot_a, ballot_bc, ballot_d]
def P₂_₅ : Profile := ![ballot_a, ballot_bc, ballot_cd]
def P₃ : Profile := ![ballot_a, ballot_b, ballot_cd]
def P₃_₅ : Profile := ![ballot_a, ballot_bd, ballot_cd]
def P₄ : Profile := ![ballot_a, ballot_bd, ballot_c]
def P₄_₅ : Profile := ![ballot_a, ballot_bd, ballot_bc]
def P₅ : Profile := ![ballot_a, ballot_d, ballot_bc]
def P₅_₅ : Profile := ![ballot_a, ballot_cd, ballot_bc]
def P₆ : Profile := ![ballot_a, ballot_cd, ballot_b]
def P₆_₅ : Profile := ![ballot_a, ballot_cd, ballot_bd]
def P₇ : Profile := ![ballot_a, ballot_c, ballot_bd]
def P₇_₅ : Profile := ![ballot_ab, ballot_c, ballot_bd]
...
lemma d_exclusive_singleton_P₁_₅ :
  ...
  · ext v
    ...
    constructor
    · intro hd_in
      fin_cases v <;> simp_all [P₁_₅, ballot_ab, ballot_bc, ballot_d]
    · intro heq
      rw [heq]
      decide
...
lemma d_in_W_P₁_₅ (f : ABCRule V C k) (hwf : IsWellFormedOnPlentiful f) (hres : f.IsResolute)
...
lemma v₂_approves_ac : (mkInstance P₁_₅ P₁_₅_proper).approves v₂ = ballot_bc := rfl
...
lemma b_in_candidates_P₂ : (0 : C) ∈ (mkInstance P₂ P₂_proper).candidates := by decide
...
lemma b_in_W_P₂ (f : ABCRule V C k) (hres : f.IsResolute) (hprop : f.SatisfiesProportionality) :
    (0 : C) ∈ W f hres P₂ P₂_proper := by
  simpa [W] using
    (ABCRule.resolute_proportionality (f := f) (hres := hres) (hprop := hprop)
      (inst := mkInstance P₂ P₂_proper) (c := (0 : C))
...
lemma step1_f_P₁_₅_eq_acd (f : ABCRule V C k) (hwf : IsWellFormedOnPlentiful f) (hres : f.IsResolute)
    (hprop : f.SatisfiesProportionality) (hsp : Peters.SatisfiesResoluteStrategyproofnessOnPlentiful f)
...
lemma step2_f_P₂_eq_bcd (f : ABCRule V C k) (hwf : IsWellFormedOnPlentiful f) (hres : f.IsResolute)
    (hprop : f.SatisfiesProportionality) (hsp : Peters.SatisfiesResoluteStrategyproofnessOnPlentiful f)
    (h_P₁ : W f hres P₁ P₁_proper = comm_bcd) :
  ...
  have hb : (0 : C) ∈ W f hres P₂ P₂_proper := b_in_W_P₂ f hres hprop
  ...
  have hW_card : W₂.card = k := by
    have hpl : inst₂.plentiful := by simpa [hinst₂] using P₂_plentiful
    exact (hwf inst₂ hpl).2 W₂ hW_mem |>.1

  have hW_cases : W₂ = comm_abd ∨ W₂ = comm_acd := by
    ...
    · right
      simpa [comm_acd] using hW_eq_acd'
    · -- impossible since a must be elected by proportionality
      have : (0 : C) ∈ ({1, 2, 3} : Finset (Fin 4)) := by
        simpa [hW_eq_bcd'] using hb
      cases (by decide : ¬(0 : C) ∈ ({1, 2, 3} : Finset (Fin 4))) this

  rcases hW_cases with hW_eq_abd | hW_eq_acd
  · have h_viol' : W₂ ∩ ballot_ab ⊃ comm_bcd ∩ ballot_ab := by
    ...
    have h_eq : f.resolute_committee (mkInstance P₁_₅ P₁_₅_proper) hres = comm_bcd := by
      simpa [W] using h_P₁_₅
    have h_viol_comm :
        f.resolute_committee inst₂ hres ∩ ballot_ab ⊃ comm_bcd ∩ ballot_ab := by
...
lemma card3_mem_bd_cases (W : Finset C) (hcard : W.card = 3)
  ...
  rcases hW_cases' with hW_eq_acd | hW_eq_bcd
  · right; simpa [comm_acd] using hW_eq_acd
...
lemma b_exclusive_singleton_P₂_₅ :
    Peters.SingletonApprovers.is_exclusive_singleton (mkInstance P₂_₅ P₂_₅_proper) (0 : C) := by
  refine exclusive_singleton_of_unique_supporter (inst := mkInstance P₂_₅ P₂_₅_proper)
    (c := (0 : C)) (v₀ := v₁) ?_ ?_ ?_
  · decide
  · rfl
  · intro v hv hne
    fin_cases v <;> simp [mkInstance, P₂_₅, ballot_a, ballot_bc, ballot_cd] at hv hne ⊢

lemma singleton_party_size_b_P₂_₅ :
    (mkInstance P₂_₅ P₂_₅_proper).singleton_party_size (0 : C) = 1 := by
  decide

lemma b_in_W_P₂_₅ (f : ABCRule V C k) (hwf : IsWellFormedOnPlentiful f) (hres : f.IsResolute)
    (hprop : f.SatisfiesProportionality) (hsp : Peters.SatisfiesResoluteStrategyproofnessOnPlentiful f) :
...
lemma step3_f_P₂_₅_eq_bcd (f : ABCRule V C k) (hwf : IsWellFormedOnPlentiful f) (hres : f.IsResolute)
    (hprop : f.SatisfiesProportionality) (hsp : Peters.SatisfiesResoluteStrategyproofnessOnPlentiful f)
    (h_P₁ : W f hres P₁ P₁_proper = comm_bcd) :
    W f hres P₂_₅ P₂_₅_proper = comm_acd := by
  have h_P₂ : W f hres P₂ P₂_proper = comm_acd :=
    step2_f_P₂_eq_bcd f hwf hres hprop hsp h_P₁
  have hb : (0 : C) ∈ W f hres P₂_₅ P₂_₅_proper := b_in_W_P₂_₅ f hwf hres hprop hsp
  have h :
...
lemma step4_f_P₃_eq_abd (f : ABCRule V C k) (hwf : IsWellFormedOnPlentiful f) (hres : f.IsResolute)
    (hprop : f.SatisfiesProportionality) (hsp : Peters.SatisfiesResoluteStrategyproofnessOnPlentiful f)
    (h_P₁ : W f hres P₁ P₁_proper = comm_bcd) :
  ...
  have ha : (1 : C) ∈ W f hres P₃ P₃_proper := a_in_W_P₃ f hres hprop
  have hb : (0 : C) ∈ W f hres P₃ P₃_proper := b_in_W_P₃ f hres hprop
  ...
  have h_gain_if_abc :
      comm_abc ∩ ballot_bc ⊃ comm_acd ∩ ballot_bc := by
    simp [comm_abc, comm_acd, ballot_bc]
    decide
...
lemma b_exclusive_singleton_P₃_₅ :
  ...
  · rfl
  · intro v hv hne
    fin_cases v <;> simp [mkInstance, P₃_₅, ballot_a, ballot_bd, ballot_cd] at hv hne ⊢
...
lemma step5_f_P₃_₅_eq_abd (f : ABCRule V C k) (hwf : IsWellFormedOnPlentiful f) (hres : f.IsResolute)
    (hprop : f.SatisfiesProportionality) (hsp : Peters.SatisfiesResoluteStrategyproofnessOnPlentiful f)
    (h_P₁ : W f hres P₁ P₁_proper = comm_bcd) :
...
lemma step6_f_P₄_eq_abc (f : ABCRule V C k) (hwf : IsWellFormedOnPlentiful f) (hres : f.IsResolute)
    (hprop : f.SatisfiesProportionality) (hsp : Peters.SatisfiesResoluteStrategyproofnessOnPlentiful f)
    (h_P₁ : W f hres P₁ P₁_proper = comm_bcd) :
  ...
  have hcard3 : (W f hres P₄ P₄_proper).card = 3 := by
    simpa [k] using (W_card f hwf hres P₄ P₄_proper P₄_plentiful)
  have hW_cases : W f hres P₄ P₄_proper = comm_abc ∨ W f hres P₄ P₄_proper = comm_acd :=
    card3_mem_bc_cases _ hcard3 hb hc

  have h_gain_if_bcd :
      comm_acd ∩ ballot_cd ⊃ comm_abd ∩ ballot_cd := by
    simp [comm_acd, comm_abd, ballot_cd]
    decide

  -- Manipulator: v₃, true ballot cd at P₃_₅, reports c at P₄
  have hW_cases' : W f hres P₄ P₄_proper = comm_acd ∨ W f hres P₄ P₄_proper = comm_abc := by
...
lemma b_exclusive_singleton_P₄_₅ :
  ...
  · rfl
  · intro v hv hne
    fin_cases v <;> simp [mkInstance, P₄_₅, ballot_a, ballot_bd, ballot_bc] at hv hne ⊢
...
lemma step7_f_P₄_₅_eq_abc (f : ABCRule V C k) (hwf : IsWellFormedOnPlentiful f) (hres : f.IsResolute)
    (hprop : f.SatisfiesProportionality) (hsp : Peters.SatisfiesResoluteStrategyproofnessOnPlentiful f)
    (h_P₁ : W f hres P₁ P₁_proper = comm_bcd) :
...
lemma step8_f_P₅_eq_bcd (f : ABCRule V C k) (hwf : IsWellFormedOnPlentiful f) (hres : f.IsResolute)
    (hprop : f.SatisfiesProportionality) (hsp : Peters.SatisfiesResoluteStrategyproofnessOnPlentiful f)
    (h_P₁ : W f hres P₁ P₁_proper = comm_bcd) :
    W f hres P₅ P₅_proper = comm_acd := by
  ...
  have hcard3 : (W f hres P₅ P₅_proper).card = 3 := by
    simpa [k] using (W_card f hwf hres P₅ P₅_proper P₅_plentiful)
  have hW_cases : W f hres P₅ P₅_proper = comm_abd ∨ W f hres P₅ P₅_proper = comm_acd :=
    card3_mem_bd_cases _ hcard3 hb hd

  have h_gain_if_abd :
      comm_abd ∩ ballot_bd ⊃ comm_abc ∩ ballot_bd := by
    simp [comm_abd, comm_abc, ballot_bd]
    decide
...
lemma b_exclusive_singleton_P₅_₅ :
  ...
  · rfl
  · intro v hv hne
    fin_cases v <;> simp [mkInstance, P₅_₅, ballot_a, ballot_cd, ballot_bc] at hv hne ⊢
...
lemma step9_f_P₅_₅_eq_bcd (f : ABCRule V C k) (hwf : IsWellFormedOnPlentiful f) (hres : f.IsResolute)
    (hprop : f.SatisfiesProportionality) (hsp : Peters.SatisfiesResoluteStrategyproofnessOnPlentiful f)
    (h_P₁ : W f hres P₁ P₁_proper = comm_bcd) :
    W f hres P₅_₅ P₅_₅_proper = comm_acd := by
  have h_P₅ : W f hres P₅ P₅_proper = comm_acd :=
...
lemma step10_f_P₆_eq_abd (f : ABCRule V C k) (hwf : IsWellFormedOnPlentiful f) (hres : f.IsResolute)
    (hprop : f.SatisfiesProportionality) (hsp : Peters.SatisfiesResoluteStrategyproofnessOnPlentiful f)
    (h_P₁ : W f hres P₁ P₁_proper = comm_bcd) :
    W f hres P₆ P₆_proper = comm_abd := by
  have h_P₅_₅ : W f hres P₅_₅ P₅_₅_proper = comm_acd :=
...
lemma b_exclusive_singleton_P₆_₅ :
  ...
  · rfl
  · intro v hv hne
    fin_cases v <;> simp [mkInstance, P₆_₅, ballot_a, ballot_cd, ballot_bd] at hv hne ⊢
...
lemma step11_f_P₆_₅_eq_abd (f : ABCRule V C k) (hwf : IsWellFormedOnPlentiful f) (hres : f.IsResolute)
    (hprop : f.SatisfiesProportionality) (hsp : Peters.SatisfiesResoluteStrategyproofnessOnPlentiful f)
    (h_P₁ : W f hres P₁ P₁_proper = comm_bcd) :
    W f hres P₆_₅ P₆_₅_proper = comm_abd := by
  have h_P₆ : W f hres P₆ P₆_proper = comm_abd :=
...
lemma step12_f_P₇_eq_abc (f : ABCRule V C k) (hwf : IsWellFormedOnPlentiful f) (hres : f.IsResolute)
    (hprop : f.SatisfiesProportionality) (hsp : Peters.SatisfiesResoluteStrategyproofnessOnPlentiful f)
    (h_P₁ : W f hres P₁ P₁_proper = comm_bcd) :
    W f hres P₇ P₇_proper = comm_abc := by
  have h_P₆_₅ : W f hres P₆_₅ P₆_₅_proper = comm_abd :=
...
lemma c_exclusive_singleton_P₇_₅ :
  ...
  · rfl
  · intro v hv hne
    fin_cases v <;> simp [mkInstance, P₇_₅, ballot_ab, ballot_c, ballot_bd] at hv hne ⊢

lemma singleton_party_size_c_P₇_₅ :
    (mkInstance P₇_₅ P₇_₅_proper).singleton_party_size (2 : C) = 1 := by
  decide

lemma c_in_W_P₇_₅ (f : ABCRule V C k) (hwf : IsWellFormedOnPlentiful f) (hres : f.IsResolute)
    (hprop : f.SatisfiesProportionality) (hsp : Peters.SatisfiesResoluteStrategyproofnessOnPlentiful f) :
...
lemma step13_f_P₇_₅_eq_abc (f : ABCRule V C k) (hwf : IsWellFormedOnPlentiful f) (hres : f.IsResolute)
    (hprop : f.SatisfiesProportionality) (hsp : Peters.SatisfiesResoluteStrategyproofnessOnPlentiful f)
    (h_P₁ : W f hres P₁ P₁_proper = comm_bcd) :
    W f hres P₇_₅ P₇_₅_proper = comm_abc := by
  have h_P₇ : W f hres P₇ P₇_proper = comm_abc :=
...
theorem contradiction_from_P₁_eq_bcd (f : ABCRule V C k) (hwf : IsWellFormedOnPlentiful f) (hres : f.IsResolute)
    (hprop : f.SatisfiesProportionality) (hsp : Peters.SatisfiesResoluteStrategyproofnessOnPlentiful f)
    (h_P₁ : W f hres P₁ P₁_proper = comm_bcd) :
    False := by
  have h_P₇_₅ : W f hres P₇_₅ P₇_₅_proper = comm_abc :=
  ...
  have h_viol :
      W f hres P₁ P₁_proper ∩ ballot_bd ⊃ W f hres P₇_₅ P₇_₅_proper ∩ ballot_bd := by
    simp [h_P₁, h_P₇_₅, comm_bcd, comm_abc, ballot_bd]
    decide
